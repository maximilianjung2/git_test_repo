...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO haaschterrunden2025_teilnehmer (Name, Vorname, Typ,Veranstaltung,Distanz) VALUES ('$name', '$vorname', $typ, 'Faschingslauf2026','$distanz')";
    // echo $sql;
